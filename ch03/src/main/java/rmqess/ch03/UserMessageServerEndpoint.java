        ...
        final Subscription subscription = userMessageManager.subscribeToUserInbox(userId,
                new SubscriptionDeliveryHandler() {
                    ...
                    public void handleDelivery(final Channel channel,
                                               ...
                                               final byte[] body) {
                        try {
                            // sending ths messages consumed from the user-specific queue on WebSocket
                            ...
                            // manual message acknowledgement with the basicAck channel action
                            // Only if SendText WebSocket operation has succeeded
